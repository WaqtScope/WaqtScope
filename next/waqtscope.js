...
//    tableText+= Info.latitude()+" " + Info.longitude()+"<br/>";
		...
		tableText+= "<colgroup><col class='col-date'><col class='col-time'><col class='col-time'><col class='col-time'><col class='col-time'><col class='col-time'><col class='col-time'><col class='col-time'><col class='col-time'></colgroup>";
...
function brfInfo(tag){
		var text = "";
		text+="<span class='foot-item foot-loc'>"+ LocData.City[Info.cityId][0]+', '+LocData.ContryList[Info.countryId][0]+"</span>"
				+"<span class='foot-item foot-method'>Calc: "+ prayTimes.getMethod() + "</span>"
				+"<span class='foot-item foot-method'>Asr: "+ prayTimes.getSetting().asr + "</span>"
				+"<span class='foot-item foot-loc'>UTC"+ Util.signNum(Util.dig2f(Info.timeZone)) + "</span>"
				;
		return text;
}
...
//    $('#currentState').html($currentState);
		...
		$('#stickyLocation').html(LocData.City[Info.cityId][0]+', '+LocData.ContryList[Info.countryId][0]);
//    $.get("syn-vis.php");
