...
<html>
    <head>
        ...
        <link rel="icon" href="../nafsadh full with bg2.ico" type="image/x-icon" />
        <link rel="shortcut icon" href="../nafsadh full with bg2.ico" type="image/x-icon" />
...
//                var longt = (39+49/60+34/3600);
        ...
        // have some cookies
            ...
            Info.cityId = $.cookie(_C.cityId()) || 142;
            Info.countryId = $.cookie(_C.countryID()) || 12;
            Info.manSetLLA = $.cookie(_C.manSetLLA()) || 0;
